...
function updateScreen() {
  ...
  if (upgradeShopOpen == true) {
    ...
    if (timePlayed <= 60000) {
    timePlayedString.textContent = "You've played for " + Math.round(timePlayed/1000) + " seconds";
    } else if (timePlayed > 60000 && timePlayed <= 3600000) {
    timePlayedString.textContent = "You've played for " + Math.round(timePlayed/60000) + " minutes";
    } else if (timePlayed > 3600000) {
    timePlayedString.textContent = "You've played for " + Math.round(timePlayed/3600000) + " hours";
    }
  shopUnlockedCheck();
}
...
upgradeButton.addEventListener("click", function() {
  ...
  upgradeShopPanel.style.display = "inline-block";
});
